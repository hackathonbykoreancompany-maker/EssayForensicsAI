...
export default function MethodologyModal({ isOpen, onClose, title = "Linguistic Analysis Methodology" }: MethodologyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/70 backdrop-blur-sm">
      <div className="bg-slate-950 border border-slate-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-y-auto flex flex-col p-6 space-y-5">
        {/* Modal Header */}
        ...
        <div className="space-y-4 text-xs leading-relaxed text-slate-300">
          <section className="space-y-1.5 p-3.5 rounded-xl bg-slate-900/60 border border-slate-800">
            <h3 className="text-sm font-semibold text-white flex items-center gap-2">
              <span className="w-5 h-5 rounded bg-slate-800 text-sky-400 border border-slate-700 inline-flex items-center justify-center font-mono font-bold text-xs">1</span>
          ...
          <section className="space-y-1.5 p-3.5 rounded-xl bg-slate-900/60 border border-slate-800">
            <h3 className="text-sm font-semibold text-white flex items-center gap-2">
              <span className="w-5 h-5 rounded bg-slate-800 text-sky-400 border border-slate-700 inline-flex items-center justify-center font-mono font-bold text-xs">2</span>
          ...
          <section className="space-y-1.5 p-3.5 rounded-xl bg-slate-900/60 border border-slate-800">
            <h3 className="text-sm font-semibold text-white flex items-center gap-2">
              <span className="w-5 h-5 rounded bg-slate-800 text-sky-400 border border-slate-700 inline-flex items-center justify-center font-mono font-bold text-xs">3</span>
          ...
          <section className="space-y-1.5 p-3.5 rounded-xl bg-slate-900/60 border border-slate-800">
            <h3 className="text-sm font-semibold text-white flex items-center gap-2">
              <span className="w-5 h-5 rounded bg-slate-800 text-sky-400 border border-slate-700 inline-flex items-center justify-center font-mono font-bold text-xs">4</span>
          ...
          <section className="space-y-1.5 p-3.5 rounded-xl bg-slate-900/60 border border-slate-800">
            <h3 className="text-sm font-semibold text-white flex items-center gap-2">
              <span className="w-5 h-5 rounded bg-slate-800 text-sky-400 border border-slate-700 inline-flex items-center justify-center font-mono font-bold text-xs">5</span>
